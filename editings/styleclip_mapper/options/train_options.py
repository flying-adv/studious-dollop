...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--ir_se50_weights', default='/content/drive/MyDrive/diffusion_based/HFGI/pretrained/model_ir_se50.pth', type=str, help="Path to facial recognition network used in ID loss")
