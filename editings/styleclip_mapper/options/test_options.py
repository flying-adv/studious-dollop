...
class TestOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--ckpt', default="/content/drive/MyDrive/diffusion_based/HFGI/experiment/ffhq_11/checkpoints/iteration_14000.pt", type=str, help='Path to HFGI ckpt model weights')
        ...
        self.parser.add_argument('--latents_test_path', default='/content/drive/MyDrive/diffusion_based/HFGI/test_faces.pt', type=str, help="The latents for the validation")
