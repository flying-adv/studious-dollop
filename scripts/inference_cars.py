...
from utils.model_utils_cars import setup_model
...
def main(args):
    ...
    for i, batch in enumerate(tqdm(data_loader)):
        ...
        res = x -  torch.nn.functional.interpolate(torch.clamp(imgs, -1., 1.), size=(192,256) , mode='bilinear')
        ...
        img_edit = torch.nn.functional.interpolate(torch.clamp(img_edit, -1., 1.), size=(192,256) , mode='bilinear')
        ...
        # save images
        imgs = torch.nn.functional.interpolate(imgs, size=(192,256) , mode='bilinear')
