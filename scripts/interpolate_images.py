...
def main(args):
    ...
    for i, batch in enumerate(tqdm(data_loader)):
        ...
        conditions_ = net.residue(torch.cat((res_style, img_edit  ), 1))
        for inte in range(15):
            inte = inte * 0.1
            conditions[1] += inte * conditions_[1]
            ...
            im_save_path = os.path.join(edit_directory_path, f"{i:05d}_{inte}.jpg")
