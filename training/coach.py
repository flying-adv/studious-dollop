...
class Coach:
    ...
    def train(self):
        ...
        while self.global_step < self.opts.max_steps:
            for batch_idx, batch in enumerate(self.train_dataloader):
                ...
                x, y, y_hat, latent, res_delta, rec , loss_diff = self.forward(batch)
    ...
    def forward(self, batch):
        ...
        y_hat, latent, res_delta, rec , loss_diff = self.net.forward(x, return_latents=True)
        if self.opts.dataset_type == "cars_encode":
            y_hat = y_hat[:, :, 32:224, :]
        return x, y, y_hat, latent, res_delta, rec , loss_diff
